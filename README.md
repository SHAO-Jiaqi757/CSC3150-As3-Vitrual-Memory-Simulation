...
<img width="90%"  src="./report/GPU.jpg"></img>
 <div style="text-align: center">Fig.1.1 Memory Arrangement</div>
  <img width="80%"  src="./report/IPT.jpg"></img>
  </div>
  <!-- ![](IPT.jpg) -->
...
<div style="text-align: center">
<img width="60%"  src="./report/TPT_struc.jpg"></img>
...
<div style="text-align: center">
<img width="60%" src="./report/vm_read.png"/>
...
<div style="text-align: center">
<img width="50%" src="./report/bonus_output.png"/>
<div>Fig.3.1 Page fault number</div>
<div>&nbsp;</div>
<img width="60%" src="./report/snapshots.png"/>
